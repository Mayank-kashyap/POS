...
public class ProductServiceTest extends AbstractUnitTest{
    ...
    public void testAdd() throws ApiException {
        ...
        assertEquals(p.getBrandPojo(), productService.get(p.getId()).getBrandPojo());
    ...
    public void testDelete() throws ApiException {
        ...
        assertEquals(product_list_before.size() - 1, product_list_after.size());
        try {
            productService.get(p.getId());
            fail("ApiException did not occur");
        } catch (ApiException e) {
            assertEquals(e.getMessage(), "Product with given ID does not exist, id: " + p.getId());
        }
    ...
    public void testGetById() throws ApiException {
        ...
        assertEquals(productPojoList.get(0).getBrandPojo(), db_product_pojo.getBrandPojo());
